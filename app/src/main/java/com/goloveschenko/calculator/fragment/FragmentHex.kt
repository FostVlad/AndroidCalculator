...
class FragmentHex : Fragment() {
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        button.setOnClickListener(activity as MainActivity)
        button = view.findViewById(R.id.button8) as Button
        button.setOnClickListener(activity as MainActivity)
        button = view.findViewById(R.id.button9) as Button
        button.setOnClickListener(activity as MainActivity)
        button = view.findViewById(R.id.buttonA) as Button
        button.setOnClickListener(activity as MainActivity)
        button = view.findViewById(R.id.buttonB) as Button
        button.setOnClickListener(activity as MainActivity)
        button = view.findViewById(R.id.buttonC) as Button
        button.setOnClickListener(activity as MainActivity)
        button = view.findViewById(R.id.buttonD) as Button
        button.setOnClickListener(activity as MainActivity)
        button = view.findViewById(R.id.buttonE) as Button
        button.setOnClickListener(activity as MainActivity)
        button = view.findViewById(R.id.buttonF) as Button
        button.setOnClickListener(activity as MainActivity)
